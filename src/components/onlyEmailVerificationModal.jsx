...
export default function Modal({ displayModal, setDisplayModal, modal, count, setCount, setAppAuthButton, setEmailAuthButton }) {
    ...
    let { command , setCommand} = useCommand(); // Get current command
                        ...
                        <div style={{
                            ...
                            <div className='h-auto min-h-[452px] px-[1.5rem] py-0 w-full md:px-[2.5rem]'>
                                ...
                                <div className={`mb-8 ${theme === 'light' ? 'text-[#474D57]' : 'text-white'} md:w-[300px] text-[14px] md:text-[16px] font-normal leading-[24px] sm:leading-[22px]`}>
                                    {modal === 'AuthApp' ? 'Please enter the 6-digit code generated by your authenticator app.' : `Enter the 6-digit verification code sent to ${maskEmail(userEmail)}`}
                                </div>
                                <div>
