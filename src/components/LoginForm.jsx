...
import { openAuthPopup } from '../app/lib/PopupBrowser';
            ...
            <div className='h-full w-full flex md:justify-center flex-col md:items-center' style={{ padding }}>
                <div className={`md:border ${theme === 'light' ? 'md:border-[#eaecef]' : 'md:border-[#2b3139]'} rounded-[24px] md:w-[425px] w-full min-h-[fit] md:min-h-[589px] md:px-[40px] md:pt-[40px] md:pb-[10px]`}>
                    ...
                    <form>
                        <div>
                            <div className='flex flex-column text-[14px] font-normal leading-[22px] mb-2'>
                                <div className={` ${theme === 'light' ? 'text-[#1e2329]' : 'text - [#202630] '} -mb-1 font-normal`}>
                                    Email/Phone number
                                </div>
                            </div>
                    ...
                    <div className='w-full'>
                        <button className={`h-[48px] mb-[16px] w-full border ${theme === 'dark' && 'border-[#474d57]'} md:p-0 pl-5 md:justify-center flex items-center rounded-[10px]`} onClick={() => Authentication('/GoogleAuthPage')}>
                        ...
                        <button className={`h-[48px] mb-[16px] w-full border ${theme === 'dark' && 'border-[#474d57]'}  md:p-0 pl-5 md:justify-center flex items-center rounded-[10px]`} onClick={() => Authentication('/AppleAuthPage')}>
                            <div className='relative md:absolute md:mr-[294px]'>
